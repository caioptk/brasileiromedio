                        ...
                        <div class="about-footer-rightside">
                            <div class="about-footer-upgrade">
                                ...
                                <div class="footer-upgrade-link">
                                    <a target="_blank" class="button button-primary button-primary-upgrade" href="<?php echo esc_url( 'https://www.themeinwp.com/theme/blog-expert-pro/' ); ?>"><?php esc_html_e('Upgrade to Pro','blog-prime'); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
